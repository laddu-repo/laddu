...
public final class c0 extends ReplacementSpan {
    ...
    public final b0 f893w;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public TextPaint f896z;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final Paint.FontMetricsInt f892v = new Paint.FontMetricsInt();

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public short f894x = -1;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public float f895y = 1.0f;

    public c0(b0 b0Var) {
        u1.c.g(b0Var, "rasterizer cannot be null");
        this.f893w = b0Var;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L42
        L26:
            android.text.TextPaint r3 = r0.f896z
            if (r3 != 0) goto L31
        ...
        L8f:
            r10 = r2
        L90:
            androidx.emoji2.text.b0 r2 = r0.f893w
            sb.p r3 = r2.f890b
            java.lang.Object r4 = r3.f11745z
            android.graphics.Typeface r4 = (android.graphics.Typeface) r4
            android.graphics.Typeface r5 = r10.getTypeface()
            r10.setTypeface(r4)
            int r2 = r2.f889a
            int r13 = r2 * 2
            java.lang.Object r2 = r3.f11743x
            r12 = r2
            char[] r12 = (char[]) r12
            r14 = 2
            r11 = r19
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.c0.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }

    @Override // android.text.style.ReplacementSpan
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i10, Paint.FontMetricsInt fontMetricsInt) {
        Paint.FontMetricsInt fontMetricsInt2 = this.f892v;
        paint.getFontMetricsInt(fontMetricsInt2);
        float fAbs = Math.abs(fontMetricsInt2.descent - fontMetricsInt2.ascent) * 1.0f;
        b0 b0Var = this.f893w;
        this.f895y = fAbs / (b0Var.b().a(14) != 0 ? ((ByteBuffer) r8.f6649y).getShort(r1 + r8.f6646v) : (short) 0);
        j1.a aVarB = b0Var.b();
        int iA = aVarB.a(14);
        if (iA != 0) {
            ((ByteBuffer) aVarB.f6649y).getShort(iA + aVarB.f6646v);
        }
        short s3 = (short) ((b0Var.b().a(12) != 0 ? ((ByteBuffer) r5.f6649y).getShort(r7 + r5.f6646v) : (short) 0) * this.f895y);
        this.f894x = s3;
