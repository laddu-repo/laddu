...
public final class Dav1dDecoder implements e {
    ...
    public Dav1dDecoder(int i, int i10, int i11, int i12, int i13, boolean z2) throws b {
        boolean zA;
        try {
            zA = c.f1526a.a();
        ...
        for (int i15 = 0; i15 < this.availableOutputBufferCount; i15++) {
            this.availableOutputBuffers[i15] = new VideoDecoderOutputBuffer(new d1(1, this));
        }
        a aVar = new a(this, i12, i13, z2);
    ...
    public native int dav1dCheckError(long j8);

    /* JADX INFO: Access modifiers changed from: private */
    public native void dav1dClose(long j8);

    private native int dav1dDecode(long j8, DecoderInputBuffer decoderInputBuffer, int i, int i10, boolean z2, int i11, long j9, int i12);

    private native void dav1dFlush(long j8);

    /* JADX INFO: Access modifiers changed from: private */
    public native String dav1dGetErrorMessage(long j8);

    private native int dav1dGetFrame(long j8, VideoDecoderOutputBuffer videoDecoderOutputBuffer);

    /* JADX INFO: Access modifiers changed from: private */
    public native long dav1dInit(int i, int i10, boolean z2);

    private native void dav1dReleaseFrame(long j8, VideoDecoderOutputBuffer videoDecoderOutputBuffer);

    private native int dav1dRenderFrame(long j8, Surface surface, VideoDecoderOutputBuffer videoDecoderOutputBuffer);
        ...
        synchronized (this.lock) {
            try {
                ...
                if (decoderInputBufferRemoveFirst.isEndOfStream()) {
                    ...
                    boolean z2 = !isAtLeastOutputStartTimeUs(decoderInputBufferRemoveFirst.timeUs);
                    int i10 = decoderInputBufferRemoveFirst.isFirstSample() ? 134217728 : 0;
                    try {
                        byteBuffer = decoderInputBufferRemoveFirst.data;
                        int i11 = b0.f13686a;
                        dav1dDecoder = this;
                    } catch (b e7) {
                        e = e7;
                    ...
                    try {
                        if (dav1dDecoder.dav1dDecode(this.dav1dDecoderContext, decoderInputBufferRemoveFirst, byteBuffer.position(), byteBuffer.remaining(), z2, i10, decoderInputBufferRemoveFirst.timeUs, this.outputMode) == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public native void releaseUnusedInputBuffers(long j8, Dav1dDecoder dav1dDecoder);
    ...
    public final boolean isAtLeastOutputStartTimeUs(long j8) {
        boolean z2;
        synchronized (this.lock) {
            long j9 = this.outputStartTimeUs;
            z2 = j9 == -9223372036854775807L || j8 >= j9;
        }
        return z2;
    }
    ...
    public final DecoderInputBuffer dequeueInputBuffer() {
        ...
        synchronized (this.lock) {
            try {
                maybeThrowException();
                v.r(this.dequeuedInputBuffer == null || this.flushed);
                int i = this.availableInputBufferCount;
                if (i == 0 || this.flushed) {
    ...
    public final void queueInputBuffer(DecoderInputBuffer decoderInputBuffer) {
        synchronized (this.lock) {
            maybeThrowException();
            v.j(decoderInputBuffer == this.dequeuedInputBuffer);
