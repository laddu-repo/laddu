...
public class AlertDialogLayout extends y1 {
    ...
    */
    ...
    public final void onMeasure(int i6, int i10) {
        ...
        int i20 = i10;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + i18, i6, i11), View.resolveSizeAndState(paddingBottom, i20, 0));
        if (mode2 != 1073741824) {
            ...
            while (i21 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) x1Var).width == -1) {
                        int i22 = ((LinearLayout.LayoutParams) x1Var).height;
                        ...
                        ((LinearLayout.LayoutParams) x1Var).height = i22;
                    }
                }
                i21++;
