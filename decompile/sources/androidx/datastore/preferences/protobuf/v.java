...
public abstract class v extends a {
    ...
    public static final boolean f(v vVar, boolean z2) {
    ...
    public final int a(u0 u0Var) {
        ...
        if (g()) {
            ...
            throw new IllegalStateException(d0.d.h(iH2, "serialized size must be non-negative, was "));
        }
    ...
    public final void k(int i) {
        if (i < 0) {
            throw new IllegalStateException(d0.d.h(i, "serialized size must be non-negative, was "));
        }
