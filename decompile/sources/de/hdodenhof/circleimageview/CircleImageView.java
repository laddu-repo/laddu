...
public class CircleImageView extends ImageView {
    ...
    public final RectF f4512v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final RectF f4513w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public final Matrix f4514x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public final Paint f4515y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public final Paint f4516z;

    public CircleImageView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        this.f4512v = new RectF();
        this.f4513w = new RectF();
        this.f4514x = new Matrix();
        this.f4515y = new Paint();
        this.f4516z = new Paint();
        this.A = new Paint();
        this.B = -16777216;
        this.C = 0;
        this.D = 0;
    ...
    public final void b() {
        ...
        Paint paint = this.f4515y;
        paint.setAntiAlias(true);
        paint.setDither(true);
        paint.setFilterBitmap(true);
        paint.setShader(this.F);
        Paint.Style style = Paint.Style.STROKE;
        Paint paint2 = this.f4516z;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i = this.D;
        RectF rectF = this.f4512v;
        if (i != 0) {
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), this.I, this.A);
        }
        canvas.drawCircle(rectF.centerX(), rectF.centerY(), this.I, this.f4515y);
        if (this.C > 0) {
            RectF rectF2 = this.f4513w;
            canvas.drawCircle(rectF2.centerX(), rectF2.centerY(), this.J, this.f4516z);
        }
    }
