...
public class o extends AutoCompleteTextView implements w0.k {
    public static final int[] A = {R.attr.popupBackground};

    /* renamed from: x, reason: collision with root package name */
    public final o4.j f10332x;

    /* renamed from: y, reason: collision with root package name */
    public final x0 f10333y;

    /* renamed from: z, reason: collision with root package name */
    public final b0 f10334z;
    ...
    public final void drawableStateChanged() {
        ...
        o4.j jVar = this.f10332x;
        if (jVar != null) {
            jVar.b();
        }
        x0 x0Var = this.f10333y;
        if (x0Var != null) {
            x0Var.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f10333y.d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f10333y.e();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f10334z.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f10334z.a(keyListener));
    }
