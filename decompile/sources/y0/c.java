...
public final class c extends Filter {
    ...
    public final CharSequence convertResultToString(Object obj) {
        return ((z2) this.f14361a).c((Cursor) obj);
    }
    ...
    */
    public final android.widget.Filter.FilterResults performFiltering(java.lang.CharSequence r5) {
        ...
        L47:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: y0.c.performFiltering(java.lang.CharSequence):android.widget.Filter$FilterResults");
    }

    @Override // android.widget.Filter
    public final void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
        b bVar = this.f14361a;
        Cursor cursor = bVar.f14358x;
