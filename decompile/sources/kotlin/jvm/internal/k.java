...
public abstract class k {
    ...
    public static final Object[] f8049a = new Object[0];
    ...
    public static void k(String str) {
        RuntimeException runtimeException = new RuntimeException(h8.c.m("lateinit property ", str, " has not been initialized"));
        h(runtimeException, k.class.getName());
