...
public final class c {
    ...
    public static void c(c cVar, String str, ce.a aVar) {
        cVar.getClass();
        i.e(str, "name");
        i.e(aVar, "block");
    ...
    public final boolean b() {
        a aVar = this.f6298d;
        if (aVar != null && aVar.f6291b) {
            this.f = true;
        }
        ArrayList arrayList = this.f6299e;
        boolean z2 = false;
        for (int size = arrayList.size() - 1; -1 < size; size--) {
            if (((a) arrayList.get(size)).f6291b) {
                Logger logger = this.f6295a.f6303b;
    ...
    public final void d(a aVar, long j8) {
        ...
        synchronized (this.f6295a) {
            if (!this.f6297c) {
                ...
                Logger logger2 = this.f6295a.f6303b;
    ...
    */
    public final boolean e(hf.a r12, long r13, boolean r15) {
        /*
            r11 = this;
            hf.d r0 = r11.f6295a
            java.util.logging.Logger r0 = r0.f6303b
        ...
        L12:
            ...
            long r3 = r1 + r13
            java.util.ArrayList r5 = r11.f6299e
        ...
        L39:
            ...
            if (r15 == 0) goto L51
            long r3 = r3 - r1
            java.lang.String r15 = b8.h.p(r3)
        ...
        L89:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: hf.c.e(hf.a, long, boolean):boolean");
    }
