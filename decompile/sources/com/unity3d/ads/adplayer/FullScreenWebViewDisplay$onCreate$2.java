...
public final class FullScreenWebViewDisplay$onCreate$2 extends j implements p {
    int label;
    final /* synthetic */ FullScreenWebViewDisplay this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FullScreenWebViewDisplay$onCreate$2(FullScreenWebViewDisplay fullScreenWebViewDisplay, c cVar) {
        super(2, cVar);
    ...
    public final c create(Object obj, c cVar) {
        return new FullScreenWebViewDisplay$onCreate$2(this.this$0, cVar);
    }

    @Override // ve.p
    public final Object invoke(c0 c0Var, c cVar) {
        return ((FullScreenWebViewDisplay$onCreate$2) create(c0Var, cVar)).invokeSuspend(y.f6101a);
    }
