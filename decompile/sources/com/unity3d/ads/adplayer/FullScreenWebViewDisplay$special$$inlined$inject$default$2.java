...
public final class FullScreenWebViewDisplay$special$$inlined$inject$default$2 extends l implements ve.a {
    ...
    public final ISDKDispatchers invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(ISDKDispatchers.class));
    }
}
