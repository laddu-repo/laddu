...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends l implements a {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(DiagnosticEventRequestWorkModifier.class));
    }
}
