...
public final class DiagnosticEventJob$special$$inlined$inject$default$1 extends l implements a {
    ...
    public final GetRequestPolicy invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(GetRequestPolicy.class));
    }
}
