...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends l implements a {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(UniversalRequestDataSource.class));
    }
}
