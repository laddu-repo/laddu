...
public final class CommonAdViewerExposedFunctionsKt$omImpression$1$invoke$1 extends c {
    int label;
    /* synthetic */ Object result;
    final /* synthetic */ CommonAdViewerExposedFunctionsKt$omImpression$1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CommonAdViewerExposedFunctionsKt$omImpression$1$invoke$1(CommonAdViewerExposedFunctionsKt$omImpression$1 commonAdViewerExposedFunctionsKt$omImpression$1, le.c cVar) {
        super(cVar);
