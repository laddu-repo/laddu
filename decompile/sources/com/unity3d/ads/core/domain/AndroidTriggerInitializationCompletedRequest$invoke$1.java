...
public final class AndroidTriggerInitializationCompletedRequest$invoke$1 extends c {
    long J$0;
    Object L$0;
    int label;
    ...
    public AndroidTriggerInitializationCompletedRequest$invoke$1(AndroidTriggerInitializationCompletedRequest androidTriggerInitializationCompletedRequest, le.c cVar) {
        super(cVar);
