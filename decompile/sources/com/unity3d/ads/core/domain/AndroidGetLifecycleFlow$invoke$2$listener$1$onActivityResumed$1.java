...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1 extends j implements p {
    ...
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1(v vVar, Activity activity, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(c0 c0Var, c cVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1) create(c0Var, cVar)).invokeSuspend(y.f6101a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i6 != 0) {
            ...
            this.label = 1;
            Object i10 = ((u) vVar).A.i(resumed, this);
