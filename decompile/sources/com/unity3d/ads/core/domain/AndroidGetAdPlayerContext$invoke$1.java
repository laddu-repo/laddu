...
public final class AndroidGetAdPlayerContext$invoke$1 extends c {
    Object L$0;
    int label;
    ...
    public AndroidGetAdPlayerContext$invoke$1(AndroidGetAdPlayerContext androidGetAdPlayerContext, le.c cVar) {
        super(cVar);
