...
public final class AndroidGetInitializationRequest$invoke$1 extends c {
    Object L$0;
    int label;
    ...
    public AndroidGetInitializationRequest$invoke$1(AndroidGetInitializationRequest androidGetInitializationRequest, le.c cVar) {
        super(cVar);
