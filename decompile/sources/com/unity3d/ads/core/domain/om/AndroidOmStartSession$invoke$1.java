...
public final class AndroidOmStartSession$invoke$1 extends c {
    Object L$0;
    Object L$1;
    int label;
    ...
    public AndroidOmStartSession$invoke$1(AndroidOmStartSession androidOmStartSession, le.c cVar) {
        super(cVar);
