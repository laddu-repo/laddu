...
public final class AndroidOmFinishSession$invoke$1 extends c {
    Object L$0;
    Object L$1;
    int label;
    ...
    public AndroidOmFinishSession$invoke$1(AndroidOmFinishSession androidOmFinishSession, le.c cVar) {
        super(cVar);
