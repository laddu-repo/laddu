    ...
    public static final class WebViewConfigurationStore extends GeneratedMessageLite<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
            ...
            public String getAdditionalFiles(int i6) {
                return ((WebViewConfigurationStore) this.instance).getAdditionalFiles(i6);
            }

            @Override // com.unity3d.ads.datastore.WebviewConfigurationStore.WebViewConfigurationStoreOrBuilder
            public ByteString getAdditionalFilesBytes(int i6) {
                return ((WebViewConfigurationStore) this.instance).getAdditionalFilesBytes(i6);
            }
            ...
            public Builder setAdditionalFiles(int i6, String str) {
                copyOnWrite();
                ((WebViewConfigurationStore) this.instance).setAdditionalFiles(i6, str);
                return this;
            }
            ...
            public Builder setVersion(int i6) {
                copyOnWrite();
                ((WebViewConfigurationStore) this.instance).setVersion(i6);
                return this;
            }
