...
public class Device {
    ...
    */
    ...
    public static JSONObject getPackageInfo(PackageManager packageManager) {
    ...
    */
    ...
    public static int getStreamMaxVolume(int i6) {
        if (ClientProperties.getApplicationContext() != null) {
            AudioManager audioManager = (AudioManager) ClientProperties.getApplicationContext().getSystemService(MimeTypes.BASE_TYPE_AUDIO);
            if (audioManager != null) {
    ...
    public static int getStreamVolume(int i6) {
        if (ClientProperties.getApplicationContext() != null) {
            AudioManager audioManager = (AudioManager) ClientProperties.getApplicationContext().getSystemService(MimeTypes.BASE_TYPE_AUDIO);
            if (audioManager != null) {
    ...
    public static boolean hasAV1Decoder() {
        if (selectAllDecodeCodecs(MimeTypes.VIDEO_AV1).size() > 0) {
            return true;
        }
        return false;
    }
