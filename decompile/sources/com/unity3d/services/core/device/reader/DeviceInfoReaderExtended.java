...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        deviceInfoData.put("timeZoneOffset", Integer.valueOf(TimeZone.getDefault().getOffset(System.currentTimeMillis()) / UnityAdsConstants.SafeGuards.InitRequestTimeoutPolicy.MIN_TIMEOUT));
        try {
