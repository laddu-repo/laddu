...
public class WebRequestThread {
    ...
    public static synchronized void setConcurrentRequestCount(int i6) {
        synchronized (WebRequestThread.class) {
            _corePoolSize = i6;
            _maximumPoolSize = i6;
            CancelableThreadPoolExecutor cancelableThreadPoolExecutor = _pool;
            if (cancelableThreadPoolExecutor != null) {
                cancelableThreadPoolExecutor.setCorePoolSize(i6);
    ...
    public static synchronized void setMaximumPoolSize(int i6) {
        synchronized (WebRequestThread.class) {
            _maximumPoolSize = i6;
            CancelableThreadPoolExecutor cancelableThreadPoolExecutor = _pool;
            if (cancelableThreadPoolExecutor != null) {
                cancelableThreadPoolExecutor.setMaximumPoolSize(i6);
            }
        }
    }
