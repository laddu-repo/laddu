...
import com.unity3d.services.ads.b;
...
public class SdkProperties {
    ...
    public static String getConfigUrl() {
        if (_configUrl == null) {
            _configUrl = getDefaultConfigUrl(BuildConfig.BUILD_TYPE);
        }
        return _configUrl;
    }
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    Utilities.wrapCustomerListener(new b(iUnityAdsInitializationListener, 1));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static void notifyInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                Iterator it = linkedHashSet2.iterator();
                while (it.hasNext()) {
                    Utilities.wrapCustomerListener(new e1((IUnityAdsInitializationListener) it.next(), unityAdsInitializationError, str, 3));
                }
            } catch (Throwable th) {
                throw th;
            }
