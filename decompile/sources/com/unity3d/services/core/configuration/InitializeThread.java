...
public class InitializeThread extends Thread {
    ...
    /* compiled from: r8-map-id-7bd85f1e2f7c008961cee9e44e2adc91279c207f1e1906d6942eb2d5ada0c5e8 */
    /* renamed from: com.unity3d.services.core.configuration.InitializeThread$1 */
    /* loaded from: classes.dex */
    ...
    /* compiled from: r8-map-id-7bd85f1e2f7c008961cee9e44e2adc91279c207f1e1906d6942eb2d5ada0c5e8 */
    /* renamed from: com.unity3d.services.core.configuration.InitializeThread$2 */
    /* loaded from: classes.dex */
    ...
    public static abstract class InitializeState {
        ...
        public /* synthetic */ InitializeState(AnonymousClass1 anonymousClass1) {
            this();
        }
    }
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        /* compiled from: r8-map-id-7bd85f1e2f7c008961cee9e44e2adc91279c207f1e1906d6942eb2d5ada0c5e8 */
        /* renamed from: com.unity3d.services.core.configuration.InitializeThread$InitializeStateConfig$1 */
        /* loaded from: classes.dex */
        public class AnonymousClass1 implements IConfigurationLoaderListener {
            final /* synthetic */ Configuration val$legacyConfiguration;
            final /* synthetic */ SDKMetricsSender val$sdkMetricsSender;

            public AnonymousClass1(SDKMetricsSender sDKMetricsSender, Configuration configuration) {
                r2 = sDKMetricsSender;
                r3 = configuration;
            }
            ...
            public void onError(String str) {
                r2.sendMetric(TSIMetric.newEmergencySwitchOff());
                InitializeStateConfig initializeStateConfig = InitializeStateConfig.this;
                initializeStateConfig._nextState = initializeStateConfig.executeLegacy(r3);
            }
        ...
        public InitializeState executeWithLoader() {
            ...
            try {
                HttpClient httpClient = (HttpClient) f0.B(i.f8353x, new a((HttpClientProvider) Utilities.getService(HttpClientProvider.class), 0));
                ...
                try {
                    ...
                    int i6 = this._retries;
                    if (i6 < this._maxRetries) {
                        this._retryDelay = (long) (this._retryDelay * this._scalingFactor);
                        this._retries = i6 + 1;
                        InitializeEventsMetricSender.getInstance().onRetryConfig();
                        return new InitializeStateRetry(this, this._retryDelay);
    ...
    public static class InitializeStateDownloadWebView extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    try {
                        String obj = ((HttpClient) f0.B(i.f8353x, new a((HttpClientProvider) Utilities.getService(HttpClientProvider.class), 1))).executeBlocking(new HttpRequest(this._configuration.getWebViewUrl())).getBody().toString();
    ...
    public static class InitializeStateLoadWeb extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    try {
                        String obj = ((HttpClient) f0.B(i.f8353x, new a((HttpClientProvider) Utilities.getService(HttpClientProvider.class), 2))).executeBlocking(new HttpRequest(this._configuration.getWebViewUrl())).getBody().toString();
                        String webViewHash = this._configuration.getWebViewHash();
    ...
    public static class InitializeStateReset extends InitializeState {
        ...
        /* compiled from: r8-map-id-7bd85f1e2f7c008961cee9e44e2adc91279c207f1e1906d6942eb2d5ada0c5e8 */
        /* renamed from: com.unity3d.services.core.configuration.InitializeThread$InitializeStateReset$1 */
        /* loaded from: classes.dex */
        public class AnonymousClass1 implements Runnable {
            final /* synthetic */ WebViewApp val$currentApp;
            final /* synthetic */ ConditionVariable val$cv;

            public AnonymousClass1(WebViewApp webViewApp, ConditionVariable conditionVariable) {
                r2 = webViewApp;
            ...
            if (currentApp != null) {
                ...
                if (currentApp.getWebView() != null) {
                    Utilities.runOnUiThread(new Runnable() { // from class: com.unity3d.services.core.configuration.InitializeThread.InitializeStateReset.1
                        ...
                        public AnonymousClass1(WebViewApp currentApp2, ConditionVariable conditionVariable2) {
                            r2 = currentApp2;
                    ...
                    z10 = conditionVariable2.block(this._resetWebAppTimeout);
                } else {
                    z10 = true;
                }
                if (!z10) {
    ...
    public static byte[] loadCachedFileToByteArray(File file) {
