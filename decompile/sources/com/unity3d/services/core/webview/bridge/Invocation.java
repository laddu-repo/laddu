    ...
    */
    ...
    public boolean nextInvocation() {
        ...
        try {
            ...
            DeviceLog.exception("Error handling invocation " + str + "." + str2 + "(" + Arrays.toString(objArr) + ")", e10);
        }
        return true;
    }
