...
public final class UnityAdsSDK$finishOMIDSession$$inlined$inject$default$3 extends l implements a {
    ...
    public final OmFinishSession invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(OmFinishSession.class));
    }
}
