...
public class AdUnitActivity extends Activity implements IAdUnitActivity {
    ...
    public boolean onKeyDown(int i6, KeyEvent keyEvent) {
        return this._controller.onKeyDown(i6, keyEvent);
    }
    ...
    public void onRequestPermissionsResult(int i6, String[] strArr, int[] iArr) {
        this._controller.onRequestPermissionsResult(i6, strArr, iArr);
    }
    ...
    public void setLayoutInDisplayCutoutMode(int i6) {
        this._controller.setLayoutInDisplayCutoutMode(i6);
    }

    @Override // com.unity3d.services.ads.adunit.IAdUnitActivity
    public void setOrientation(int i6) {
        this._controller.setOrientation(i6);
    }

    @Override // com.unity3d.services.ads.adunit.IAdUnitActivity
    public boolean setSystemUiVisibility(int i6) {
        return this._controller.setSystemUiVisibility(i6);
    }

    @Override // com.unity3d.services.ads.adunit.IAdUnitActivity
    public void setViewFrame(String str, int i6, int i10, int i11, int i12) {
        this._controller.setViewFrame(str, i6, i10, i11, i12);
    }
