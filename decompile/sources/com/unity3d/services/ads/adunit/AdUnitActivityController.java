...
public class AdUnitActivityController {
    ...
    public boolean onKeyDown(int i6, KeyEvent keyEvent) {
        ...
        this._eventSender.sendEvent(WebViewEventCategory.ADUNIT, AdUnitEvent.KEY_DOWN, Integer.valueOf(i6), Long.valueOf(keyEvent.getEventTime()), Long.valueOf(keyEvent.getDownTime()), Integer.valueOf(keyEvent.getRepeatCount()), Integer.valueOf(this._activityId));
        return true;
    }
    ...
    public void onRequestPermissionsResult(int i6, String[] strArr, int[] iArr) {
        try {
            ...
            this._eventSender.sendEvent(WebViewEventCategory.PERMISSIONS, PermissionsEvent.PERMISSIONS_RESULT, Integer.valueOf(i6), jSONArray, jSONArray2);
        } catch (Exception e10) {
    ...
    public void setLayoutInDisplayCutoutMode(int i6) {
        this._displayCutoutMode = i6;
        if (Build.VERSION.SDK_INT >= 28 && this._adUnitActivity.getWindow() != null) {
            ...
            try {
                attributes.getClass().getField("layoutInDisplayCutoutMode").setInt(attributes, i6);
    ...
    public void setOrientation(int i6) {
        this._orientation = i6;
        this._adUnitActivity.setRequestedOrientation(i6);
    }

    public boolean setSystemUiVisibility(int i6) {
        this._systemUiVisibility = i6;
        try {
            this._adUnitActivity.getWindow().getDecorView().setSystemUiVisibility(i6);
            return true;
        } catch (Exception e10) {
