...
public final class InMemoryTokenStorage$special$$inlined$inject$default$1 extends l implements a {
    ...
    public final AsyncTokenStorage invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(AsyncTokenStorage.class));
    }
}
