...
public final class OfferwallAdapterBridge$tapjoyPlacementListener$1$5 extends j implements p {
    final /* synthetic */ String $placementName;
    int label;
    final /* synthetic */ OfferwallAdapterBridge this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OfferwallAdapterBridge$tapjoyPlacementListener$1$5(OfferwallAdapterBridge offerwallAdapterBridge, String str, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(c0 c0Var, c cVar) {
        return ((OfferwallAdapterBridge$tapjoyPlacementListener$1$5) create(c0Var, cVar)).invokeSuspend(y.f6101a);
    }
