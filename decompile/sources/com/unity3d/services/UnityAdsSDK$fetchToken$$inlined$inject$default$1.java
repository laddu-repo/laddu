...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$1 extends l implements a {
    ...
    public final TokenNumberProvider invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(TokenNumberProvider.class));
    }
}
