...
public final class UnityAdsSDK$load$$inlined$inject$default$1 extends l implements a {
    ...
    public final GetGameId invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(GetGameId.class));
    }
}
