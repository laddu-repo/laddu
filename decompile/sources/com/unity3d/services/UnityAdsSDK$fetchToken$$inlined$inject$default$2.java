...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$2 extends l implements a {
    ...
    public final GetHeaderBiddingToken invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(GetHeaderBiddingToken.class));
    }
}
