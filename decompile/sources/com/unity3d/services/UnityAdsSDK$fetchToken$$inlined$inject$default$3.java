...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$3 extends l implements a {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, x.a(GetInitializationState.class));
    }
}
