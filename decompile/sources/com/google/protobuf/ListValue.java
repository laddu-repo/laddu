...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ListValue, Builder> implements ListValueOrBuilder {
        public /* synthetic */ Builder(j2 j2Var) {
            this();
        }
        ...
        public Builder setValues(int i6, Value value) {
            copyOnWrite();
        ...
        public Builder addValues(int i6, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).addValues(i6, value);
            return this;
        }

        public Builder setValues(int i6, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).setValues(i6, builder.build());
            return this;
        }
        ...
        public Builder addValues(int i6, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).addValues(i6, builder.build());
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setValues(int i6, Value value) {
        value.getClass();
        ensureValuesIsMutable();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        Parser parser;
        j2 j2Var = null;
        switch (j2.f2957a[methodToInvoke.ordinal()]) {
            case 1:
                return new ListValue();
            case 2:
                return new Builder(j2Var);
            case 3:
    ...
    public ValueOrBuilder getValuesOrBuilder(int i6) {
        return this.values_.get(i6);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addValues(int i6, Value value) {
        value.getClass();
        ensureValuesIsMutable();
