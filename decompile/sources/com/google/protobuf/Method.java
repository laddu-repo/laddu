...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        public /* synthetic */ Builder(y2 y2Var) {
            this();
        }
        ...
        public Option getOptions(int i6) {
            return ((Method) this.instance).getOptions(i6);
        }
        ...
        public Builder removeOptions(int i6) {
            copyOnWrite();
            ((Method) this.instance).removeOptions(i6);
            return this;
        }
        ...
        public Builder setOptions(int i6, Option option) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i6, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i6) {
            copyOnWrite();
            ((Method) this.instance).setSyntaxValue(i6);
            return this;
        }
        ...
        public Builder addOptions(int i6, Option option) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i6, option);
            return this;
        }

        public Builder setOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i6, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i6, builder.build());
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        Parser parser;
        y2 y2Var = null;
        switch (y2.f3123a[methodToInvoke.ordinal()]) {
            case 1:
                return new Method();
            case 2:
                return new Builder(y2Var);
            case 3:
