...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Field, Builder> implements FieldOrBuilder {
        ...
        public Option getOptions(int i6) {
            return ((Field) this.instance).getOptions(i6);
        }
        ...
        public Builder removeOptions(int i6) {
            copyOnWrite();
            ((Field) this.instance).removeOptions(i6);
            return this;
        }
        ...
        public Builder setCardinalityValue(int i6) {
            copyOnWrite();
            ((Field) this.instance).setCardinalityValue(i6);
            return this;
        }
        ...
        public Builder setKindValue(int i6) {
            copyOnWrite();
            ((Field) this.instance).setKindValue(i6);
            return this;
        }
        ...
        public Builder setNumber(int i6) {
            copyOnWrite();
            ((Field) this.instance).setNumber(i6);
            return this;
        }

        public Builder setOneofIndex(int i6) {
            copyOnWrite();
            ((Field) this.instance).setOneofIndex(i6);
            return this;
        }

        public Builder setOptions(int i6, Option option) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i6, option);
            return this;
        }
        ...
        public Builder addOptions(int i6, Option option) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i6, option);
            return this;
        }

        public Builder setOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i6, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i6, builder.build());
            return this;
        }
    }
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Cardinality> internalValueMap = new Object();
    ...
    public enum Kind implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Kind> internalValueMap = new Object();
        private final int value;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        Parser parser;
        z0 z0Var = null;
        switch (z0.f3134a[methodToInvoke.ordinal()]) {
            case 1:
                return new Field();
            case 2:
