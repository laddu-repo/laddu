...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        static {
            ...
            BOOL = fieldType8;
            FieldType fieldType9 = new FieldType("STRING", 8, JavaType.STRING, 2, null);
            STRING = fieldType9;
            JavaType javaType3 = JavaType.MESSAGE;
            FieldType fieldType10 = new FieldType("GROUP", 9, javaType3, 3, null);
            GROUP = fieldType10;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, javaType3, 2, null);
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, 2, null);
            BYTES = fieldType12;
        ...
        public /* synthetic */ FieldType(String str, int i6, JavaType javaType, int i10, v4 v4Var) {
            this(str, i6, javaType, i10);
        }
        ...
        private FieldType(String str, int i6, JavaType javaType, int i10) {
    ...
    public static int makeTag(int i6, int i10) {
        return (i6 << 3) | i10;
    }

    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, d5 d5Var) {
        switch (v4.f3062a[fieldType.ordinal()]) {
            case 1:
            ...
            case 15:
                return d5Var.a(codedInputStream);
            case 16:
