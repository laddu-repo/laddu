...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        ...
        public Method getMethods(int i6) {
            return ((Api) this.instance).getMethods(i6);
        }
        ...
        public Mixin getMixins(int i6) {
            return ((Api) this.instance).getMixins(i6);
        }
        ...
        public Option getOptions(int i6) {
            return ((Api) this.instance).getOptions(i6);
        }
        ...
        public Builder removeMethods(int i6) {
            copyOnWrite();
            ((Api) this.instance).removeMethods(i6);
            return this;
        }

        public Builder removeMixins(int i6) {
            copyOnWrite();
            ((Api) this.instance).removeMixins(i6);
            return this;
        }

        public Builder removeOptions(int i6) {
            copyOnWrite();
            ((Api) this.instance).removeOptions(i6);
            return this;
        }

        public Builder setMethods(int i6, Method method) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i6, method);
            return this;
        }

        public Builder setMixins(int i6, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i6, mixin);
            return this;
        }
        ...
        public Builder setOptions(int i6, Option option) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i6, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i6) {
            copyOnWrite();
            ((Api) this.instance).setSyntaxValue(i6);
            return this;
        }
        ...
        public Builder addMethods(int i6, Method method) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i6, method);
            return this;
        }

        public Builder addMixins(int i6, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i6, mixin);
            return this;
        }

        public Builder addOptions(int i6, Option option) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i6, option);
            return this;
        }

        public Builder setMethods(int i6, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i6, builder.build());
            return this;
        }

        public Builder setMixins(int i6, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i6, builder.build());
            return this;
        }

        public Builder setOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i6, builder.build());
            return this;
        }
        ...
        public Builder addMethods(int i6, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i6, builder.build());
            return this;
        }

        public Builder addMixins(int i6, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i6, builder.build());
            return this;
        }

        public Builder addOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i6, builder.build());
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeMethods(int i6) {
        ensureMethodsIsMutable();
        this.methods_.remove(i6);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void removeMixins(int i6) {
        ensureMixinsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setMethods(int i6, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
        this.methods_.set(i6, method);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setMixins(int i6, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
        this.mixins_.set(i6, mixin);
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        Parser parser;
        e eVar = null;
        switch (e.f2898a[methodToInvoke.ordinal()]) {
            case 1:
                return new Api();
            case 2:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addMethods(int i6, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
        this.methods_.add(i6, method);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void addMixins(int i6, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
        this.mixins_.add(i6, mixin);
    }
