...
public final class JavaType {
    ...
    static {
        ...
        BOOLEAN = javaType6;
        JavaType javaType7 = new JavaType("STRING", 6, String.class, String.class, HttpUrl.FRAGMENT_ENCODE_SET);
        STRING = javaType7;
    ...
    private JavaType(String str, int i6, Class cls, Class cls2, Object obj) {
        this.type = cls;
        this.boxedType = cls2;
