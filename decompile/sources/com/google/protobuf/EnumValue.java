...
public final class EnumValue extends GeneratedMessageLite<EnumValue, Builder> implements EnumValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EnumValue, Builder> implements EnumValueOrBuilder {
        public /* synthetic */ Builder(r0 r0Var) {
            this();
        }
        ...
        public Option getOptions(int i6) {
            return ((EnumValue) this.instance).getOptions(i6);
        }
        ...
        public Builder removeOptions(int i6) {
            copyOnWrite();
            ((EnumValue) this.instance).removeOptions(i6);
            return this;
        }
        ...
        public Builder setNumber(int i6) {
            copyOnWrite();
            ((EnumValue) this.instance).setNumber(i6);
            return this;
        }

        public Builder setOptions(int i6, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).setOptions(i6, option);
            return this;
        }
        ...
        public Builder addOptions(int i6, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).addOptions(i6, option);
            return this;
        }

        public Builder setOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).setOptions(i6, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i6, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).addOptions(i6, builder.build());
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        Parser parser;
        r0 r0Var = null;
        switch (r0.f3032a[methodToInvoke.ordinal()]) {
            case 1:
                return new EnumValue();
            case 2:
                return new Builder(r0Var);
            case 3:
