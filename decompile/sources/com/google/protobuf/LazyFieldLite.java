...
public class LazyFieldLite {
    ...
    public void writeTo(e5 e5Var, int i6) {
        if (this.memoizedBytes != null) {
            ((l0) e5Var).a(i6, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ((l0) e5Var).a(i6, byteString);
        } else if (this.value != null) {
            ((l0) e5Var).f2978a.writeMessage(i6, this.value);
        } else {
            ((l0) e5Var).a(i6, ByteString.EMPTY);
        }
    }
