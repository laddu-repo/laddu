...
public enum g {
    ...
    f8658y("BAD_REQUEST", "Bad Request"),
    /* JADX INFO: Fake field, exist only in values array */
    EF0("UNAUTHORIZED", "Unauthorized"),
    /* JADX INFO: Fake field, exist only in values array */
    EF1("FORBIDDEN", "Forbidden"),
    /* JADX INFO: Fake field, exist only in values array */
    EF0("NOT_FOUND", "Not Found"),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    f8659z("INTERNAL_ERROR", "Internal Server Error"),
    /* JADX INFO: Fake field, exist only in values array */
    EF463("NOT_IMPLEMENTED", "Not Implemented"),
    /* JADX INFO: Fake field, exist only in values array */
    EF478("SERVICE_UNAVAILABLE", "Service Unavailable"),
    /* JADX INFO: Fake field, exist only in values array */
    EF493("UNSUPPORTED_HTTP_VERSION", "HTTP Version Not Supported");
