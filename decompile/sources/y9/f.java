...
public final class f extends i implements NavigableMap {
    ...
    public f(w0 w0Var, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new f(this.B, d().descendingMap());
    }
    ...
    public final AbstractMap.SimpleImmutableEntry e(Iterator it) {
        ...
        Collection collectionC = this.B.c();
        collectionC.addAll((Collection) entry.getValue());
        it.remove();
        return new AbstractMap.SimpleImmutableEntry(entry.getKey(), Collections.unmodifiableList((List) collectionC));
    }

    @Override // y9.i
    /* JADX INFO: renamed from: f, reason: merged with bridge method [inline-methods] */
    public final NavigableMap d() {
        return (NavigableMap) ((SortedMap) this.f14537x);
    }
    ...
    @Override // y9.i, java.util.SortedMap, java.util.NavigableMap
    ...
    @Override // y9.i, y9.d, java.util.AbstractMap, java.util.Map
