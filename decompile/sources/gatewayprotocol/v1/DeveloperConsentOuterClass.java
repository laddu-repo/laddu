...
public final class DeveloperConsentOuterClass {
    ...
    public static final class DeveloperConsent extends GeneratedMessageLite<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
            public /* synthetic */ Builder(fe.l lVar) {
                this();
            }
            ...
            public DeveloperConsentOption getOptions(int i6) {
                return ((DeveloperConsent) this.instance).getOptions(i6);
            }
            ...
            public Builder removeOptions(int i6) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).removeOptions(i6);
                return this;
            }

            public Builder setOptions(int i6, DeveloperConsentOption developerConsentOption) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).setOptions(i6, developerConsentOption);
                return this;
            }
            ...
            public Builder addOptions(int i6, DeveloperConsentOption developerConsentOption) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).addOptions(i6, developerConsentOption);
                return this;
            }

            public Builder setOptions(int i6, DeveloperConsentOption.Builder builder) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).setOptions(i6, builder.build());
                return this;
            }
            ...
            public Builder addOptions(int i6, DeveloperConsentOption.Builder builder) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).addOptions(i6, builder.build());
                return this;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setOptions(int i6, DeveloperConsentOption developerConsentOption) {
            developerConsentOption.getClass();
            ensureOptionsIsMutable();
            this.options_.set(i6, developerConsentOption);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            Parser parser;
            fe.l lVar = null;
            switch (fe.l.f5253a[methodToInvoke.ordinal()]) {
                case 1:
        ...
        public DeveloperConsentOptionOrBuilder getOptionsOrBuilder(int i6) {
            return this.options_.get(i6);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addOptions(int i6, DeveloperConsentOption developerConsentOption) {
            developerConsentOption.getClass();
            ensureOptionsIsMutable();
            this.options_.add(i6, developerConsentOption);
        }
    ...
    public enum DeveloperConsentChoice implements Internal.EnumLite {
        ...
        DeveloperConsentChoice(int i6) {
            this.value = i6;
        }

        public static DeveloperConsentChoice forNumber(int i6) {
            if (i6 != 0) {
                if (i6 != 1) {
                    if (i6 != 2) {
                        return null;
        ...
        @Deprecated
        public static DeveloperConsentChoice valueOf(int i6) {
            return forNumber(i6);
        }
    }
    ...
    public static final class DeveloperConsentOption extends GeneratedMessageLite<DeveloperConsentOption, Builder> implements DeveloperConsentOptionOrBuilder {
        ...
        private String customType_ = HttpUrl.FRAGMENT_ENCODE_SET;
        private int type_;
        private int value_;
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DeveloperConsentOption, Builder> implements DeveloperConsentOptionOrBuilder {
            ...
            public Builder setTypeValue(int i6) {
                copyOnWrite();
                ((DeveloperConsentOption) this.instance).setTypeValue(i6);
                return this;
            }
            ...
            public Builder setValueValue(int i6) {
                copyOnWrite();
                ((DeveloperConsentOption) this.instance).setValueValue(i6);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setValueValue(int i6) {
            this.value_ = i6;
        }
    ...
    public interface DeveloperConsentOrBuilder extends MessageLiteOrBuilder {
        DeveloperConsentOption getOptions(int i6);
    ...
    public enum DeveloperConsentType implements Internal.EnumLite {
        ...
        DeveloperConsentType(int i6) {
            this.value = i6;
        }

        public static DeveloperConsentType forNumber(int i6) {
            switch (i6) {
                case 0:
        ...
        @Deprecated
        public static DeveloperConsentType valueOf(int i6) {
            return forNumber(i6);
        }
    }
