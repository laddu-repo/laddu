...
public final class DynamicDeviceInfoOuterClass {
    ...
    public static final class DynamicDeviceInfo extends GeneratedMessageLite<DynamicDeviceInfo, Builder> implements DynamicDeviceInfoOrBuilder {
        ...
        private String networkOperator_ = HttpUrl.FRAGMENT_ENCODE_SET;
        private String networkOperatorName_ = HttpUrl.FRAGMENT_ENCODE_SET;
        ...
        public static final class Android extends GeneratedMessageLite<Android, Builder> implements AndroidOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Android, Builder> implements AndroidOrBuilder {
                public /* synthetic */ Builder(fe.n nVar) {
                    this();
                }
                ...
                public Builder setChargingType(int i6) {
                    copyOnWrite();
                    ((Android) this.instance).setChargingType(i6);
                    return this;
                }
                ...
                public Builder setNetworkType(int i6) {
                    copyOnWrite();
                    ((Android) this.instance).setNetworkType(i6);
                    return this;
                }
                ...
                public Builder setTelephonyManagerNetworkType(int i6) {
                    copyOnWrite();
                    ((Android) this.instance).setTelephonyManagerNetworkType(i6);
                    return this;
                }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setChargingType(int i6) {
                this.bitField0_ |= Http2.INITIAL_MAX_FRAME_SIZE;
                this.chargingType_ = i6;
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setTelephonyManagerNetworkType(int i6) {
                this.bitField0_ |= 8;
                this.telephonyManagerNetworkType_ = i6;
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                Parser parser;
                fe.n nVar = null;
                switch (fe.n.f5256a[methodToInvoke.ordinal()]) {
                    case 1:
                        return new Android();
                    case 2:
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DynamicDeviceInfo, Builder> implements DynamicDeviceInfoOrBuilder {
            ...
            public Builder setBatteryStatus(int i6) {
                copyOnWrite();
                ((DynamicDeviceInfo) this.instance).setBatteryStatus(i6);
                return this;
            }
            ...
            public Builder setConnectionTypeValue(int i6) {
                copyOnWrite();
                ((DynamicDeviceInfo) this.instance).setConnectionTypeValue(i6);
                return this;
            }
            ...
            public Builder setScreenHeight(int i6) {
                copyOnWrite();
                ((DynamicDeviceInfo) this.instance).setScreenHeight(i6);
                return this;
            }

            public Builder setScreenWidth(int i6) {
                copyOnWrite();
                ((DynamicDeviceInfo) this.instance).setScreenWidth(i6);
                return this;
            }
        ...
        public static final class Ios extends GeneratedMessageLite<Ios, Builder> implements IosOrBuilder {
            ...
            private double volume_;
            private String currentRadioAccessTechnology_ = HttpUrl.FRAGMENT_ENCODE_SET;
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Ios, Builder> implements IosOrBuilder {
                ...
                @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
                public String getLocaleList(int i6) {
                    return ((Ios) this.instance).getLocaleList(i6);
                }

                @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
                public ByteString getLocaleListBytes(int i6) {
                    return ((Ios) this.instance).getLocaleListBytes(i6);
                }
                ...
                @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
                public String getNwPathInterfaces(int i6) {
                    return ((Ios) this.instance).getNwPathInterfaces(i6);
                }

                @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
                public ByteString getNwPathInterfacesBytes(int i6) {
                    return ((Ios) this.instance).getNwPathInterfacesBytes(i6);
                }
                ...
                public Builder setCurrentUiTheme(int i6) {
                    copyOnWrite();
                    ((Ios) this.instance).setCurrentUiTheme(i6);
                    return this;
                }
                ...
                public Builder setLocaleList(int i6, String str) {
                    copyOnWrite();
                    ((Ios) this.instance).setLocaleList(i6, str);
                    return this;
                }

                public Builder setNetworkReachabilityFlags(int i6) {
                    copyOnWrite();
                    ((Ios) this.instance).setNetworkReachabilityFlags(i6);
                    return this;
                }

                public Builder setNwPathInterfaces(int i6, String str) {
                    copyOnWrite();
                    ((Ios) this.instance).setNwPathInterfaces(i6, str);
                    return this;
                }
                ...
                public Builder setTrackingAuthStatus(int i6) {
                    copyOnWrite();
                    ((Ios) this.instance).setTrackingAuthStatus(i6);
                    return this;
                }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setCurrentUiTheme(int i6) {
                this.bitField0_ |= 4;
                this.currentUiTheme_ = i6;
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setLocaleList(int i6, String str) {
                str.getClass();
                ensureLocaleListIsMutable();
                this.localeList_.set(i6, str);
            }

            /* JADX INFO: Access modifiers changed from: private */
            public void setNetworkReachabilityFlags(int i6) {
                this.bitField0_ |= 2;
                this.networkReachabilityFlags_ = i6;
            }

            /* JADX INFO: Access modifiers changed from: private */
            public void setNwPathInterfaces(int i6, String str) {
                str.getClass();
                ensureNwPathInterfacesIsMutable();
                this.nwPathInterfaces_.set(i6, str);
            }
            ...
            @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
            public String getLocaleList(int i6) {
                return this.localeList_.get(i6);
            }

            @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
            public ByteString getLocaleListBytes(int i6) {
                return ByteString.copyFromUtf8(this.localeList_.get(i6));
            }
            ...
            @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
            public String getNwPathInterfaces(int i6) {
                return this.nwPathInterfaces_.get(i6);
            }

            @Override // gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo.IosOrBuilder
            public ByteString getNwPathInterfacesBytes(int i6) {
                return ByteString.copyFromUtf8(this.nwPathInterfaces_.get(i6));
            }
        ...
        public interface IosOrBuilder extends MessageLiteOrBuilder {
            ...
            String getLocaleList(int i6);

            ByteString getLocaleListBytes(int i6);
            ...
            String getNwPathInterfaces(int i6);

            ByteString getNwPathInterfacesBytes(int i6);
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setConnectionTypeValue(int i6) {
            this.bitField0_ |= CodedOutputStream.DEFAULT_BUFFER_SIZE;
            this.connectionType_ = i6;
        }
