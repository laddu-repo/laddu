...
public final class DiagnosticEventRequestOuterClass {
    ...
    public enum DiagnosticAdType implements Internal.EnumLite {
        ...
        DiagnosticAdType(int i6) {
            this.value = i6;
        }

        public static DiagnosticAdType forNumber(int i6) {
            if (i6 != 0) {
                if (i6 != 1) {
                    if (i6 != 2) {
                        return null;
        ...
        @Deprecated
        public static DiagnosticAdType valueOf(int i6) {
            return forNumber(i6);
        }
    }
    ...
    public static final class DiagnosticEvent extends GeneratedMessageLite<DiagnosticEvent, Builder> implements DiagnosticEventOrBuilder {
        ...
        private String customEventType_ = HttpUrl.FRAGMENT_ENCODE_SET;
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DiagnosticEvent, Builder> implements DiagnosticEventOrBuilder {
            public /* synthetic */ Builder(fe.m mVar) {
                this();
            }
            ...
            @Override // gatewayprotocol.v1.DiagnosticEventRequestOuterClass.DiagnosticEventOrBuilder
            public int getIntTagsOrDefault(String str, int i6) {
                str.getClass();
            ...
            public Builder putIntTags(String str, int i6) {
                str.getClass();
                copyOnWrite();
                ((DiagnosticEvent) this.instance).getMutableIntTagsMap().put(str, Integer.valueOf(i6));
                return this;
            }
            ...
            public Builder setAdFormatValue(int i6) {
                copyOnWrite();
                ((DiagnosticEvent) this.instance).setAdFormatValue(i6);
                return this;
            }
            ...
            public Builder setAdTypeValue(int i6) {
                copyOnWrite();
                ((DiagnosticEvent) this.instance).setAdTypeValue(i6);
                return this;
            }
            ...
            public Builder setEventId(int i6) {
                copyOnWrite();
                ((DiagnosticEvent) this.instance).setEventId(i6);
                return this;
            }
            ...
            public Builder setEventTypeValue(int i6) {
                copyOnWrite();
                ((DiagnosticEvent) this.instance).setEventTypeValue(i6);
                return this;
            }

            public Builder setHeaderBiddingTokenNumber(int i6) {
                copyOnWrite();
                ((DiagnosticEvent) this.instance).setHeaderBiddingTokenNumber(i6);
                return this;
            }
        ...
        private DiagnosticEvent() {
            ...
            this.reason_ = HttpUrl.FRAGMENT_ENCODE_SET;
            this.reasonDebug_ = HttpUrl.FRAGMENT_ENCODE_SET;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setEventTypeValue(int i6) {
            this.eventType_ = i6;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setHeaderBiddingTokenNumber(int i6) {
            this.bitField0_ |= 128;
            this.headerBiddingTokenNumber_ = i6;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            Parser parser;
            fe.m mVar = null;
            switch (fe.m.f5255a[methodToInvoke.ordinal()]) {
                case 1:
                    return new DiagnosticEvent();
                case 2:
                    return new Builder(mVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0010\u0000\u0001\u0001\u0010\u0010\u0002\u0000\u0000\u0001\f\u0002ለ\u0000\u0003ဉ\u0001\u0004က\u0002\u00052\u00062\u0007\u0004\bည\u0003\tለ\u0004\nဌ\u0005\u000bဇ\u0006\fင\u0007\rဌ\b\u000eለ\t\u000fለ\n\u0010ည\u000b", new Object[]{"bitField0_", "eventType_", "customEventType_", "timestamps_", "timeValue_", "stringTags_", r.f5590a, "intTags_", q.f5588a, "eventId_", "impressionOpportunityId_", "placementId_", "adType_", "isHeaderBidding_", "headerBiddingTokenNumber_", "adFormat_", "reason_", "reasonDebug_", "errorToken_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    public interface DiagnosticEventOrBuilder extends MessageLiteOrBuilder {
        ...
        int getIntTagsOrDefault(String str, int i6);
    ...
    public static final class DiagnosticEventRequest extends GeneratedMessageLite<DiagnosticEventRequest, Builder> implements DiagnosticEventRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DiagnosticEventRequest, Builder> implements DiagnosticEventRequestOrBuilder {
            ...
            public DiagnosticEvent getBatch(int i6) {
                return ((DiagnosticEventRequest) this.instance).getBatch(i6);
            }
            ...
            public Builder removeBatch(int i6) {
                copyOnWrite();
                ((DiagnosticEventRequest) this.instance).removeBatch(i6);
                return this;
            }

            public Builder setBatch(int i6, DiagnosticEvent diagnosticEvent) {
                copyOnWrite();
                ((DiagnosticEventRequest) this.instance).setBatch(i6, diagnosticEvent);
                return this;
            }
            ...
            public Builder addBatch(int i6, DiagnosticEvent diagnosticEvent) {
                copyOnWrite();
                ((DiagnosticEventRequest) this.instance).addBatch(i6, diagnosticEvent);
                return this;
            }

            public Builder setBatch(int i6, DiagnosticEvent.Builder builder) {
                copyOnWrite();
                ((DiagnosticEventRequest) this.instance).setBatch(i6, builder.build());
                return this;
            }
            ...
            public Builder addBatch(int i6, DiagnosticEvent.Builder builder) {
                copyOnWrite();
                ((DiagnosticEventRequest) this.instance).addBatch(i6, builder.build());
                return this;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setBatch(int i6, DiagnosticEvent diagnosticEvent) {
            diagnosticEvent.getClass();
            ensureBatchIsMutable();
            this.batch_.set(i6, diagnosticEvent);
        }
        ...
        public DiagnosticEventOrBuilder getBatchOrBuilder(int i6) {
            return this.batch_.get(i6);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addBatch(int i6, DiagnosticEvent diagnosticEvent) {
            diagnosticEvent.getClass();
            ensureBatchIsMutable();
            this.batch_.add(i6, diagnosticEvent);
        }
    ...
    public interface DiagnosticEventRequestOrBuilder extends MessageLiteOrBuilder {
        DiagnosticEvent getBatch(int i6);
    ...
    public enum DiagnosticEventType implements Internal.EnumLite {
        ...
        DiagnosticEventType(int i6) {
            this.value = i6;
        }

        public static DiagnosticEventType forNumber(int i6) {
            if (i6 != 0) {
                if (i6 != 1) {
                    return null;
                }
        ...
        @Deprecated
        public static DiagnosticEventType valueOf(int i6) {
            return forNumber(i6);
        }
    }
    ...
    public enum DiagnosticEventsSeverity implements Internal.EnumLite {
        ...
        DiagnosticEventsSeverity(int i6) {
            this.value = i6;
        }

        public static DiagnosticEventsSeverity forNumber(int i6) {
            if (i6 != 0) {
                if (i6 != 1) {
                    if (i6 != 2) {
                        if (i6 != 3) {
        ...
        @Deprecated
        public static DiagnosticEventsSeverity valueOf(int i6) {
            return forNumber(i6);
        }
    }
    ...
    public static final class DiagnosticTag extends GeneratedMessageLite<DiagnosticTag, Builder> implements DiagnosticTagOrBuilder {
        ...
        private String customTagType_ = HttpUrl.FRAGMENT_ENCODE_SET;
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DiagnosticTag, Builder> implements DiagnosticTagOrBuilder {
            ...
            public Builder addTagTypeValue(int i6) {
                copyOnWrite();
                ((DiagnosticTag) this.instance).addTagTypeValue(i6);
                return this;
            }
            ...
            @Override // gatewayprotocol.v1.DiagnosticEventRequestOuterClass.DiagnosticTagOrBuilder
            public DiagnosticTagType getTagType(int i6) {
                return ((DiagnosticTag) this.instance).getTagType(i6);
            }
            ...
            @Override // gatewayprotocol.v1.DiagnosticEventRequestOuterClass.DiagnosticTagOrBuilder
            public int getTagTypeValue(int i6) {
                return ((DiagnosticTag) this.instance).getTagTypeValue(i6);
            }
            ...
            public Builder setIntValue(int i6) {
                copyOnWrite();
                ((DiagnosticTag) this.instance).setIntValue(i6);
                return this;
            }
            ...
            public Builder setTagType(int i6, DiagnosticTagType diagnosticTagType) {
                copyOnWrite();
                ((DiagnosticTag) this.instance).setTagType(i6, diagnosticTagType);
                return this;
            }

            public Builder setTagTypeValue(int i6, int i10) {
                copyOnWrite();
                ((DiagnosticTag) this.instance).setTagTypeValue(i6, i10);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addTagTypeValue(int i6) {
            ensureTagTypeIsMutable();
            this.tagType_.addInt(i6);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setTagType(int i6, DiagnosticTagType diagnosticTagType) {
            diagnosticTagType.getClass();
            ensureTagTypeIsMutable();
            this.tagType_.setInt(i6, diagnosticTagType.getNumber());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setTagTypeValue(int i6, int i10) {
            ensureTagTypeIsMutable();
            this.tagType_.setInt(i6, i10);
        }
        ...
        @Override // gatewayprotocol.v1.DiagnosticEventRequestOuterClass.DiagnosticTagOrBuilder
        public DiagnosticTagType getTagType(int i6) {
            DiagnosticTagType forNumber = DiagnosticTagType.forNumber(this.tagType_.getInt(i6));
            if (forNumber == null) {
        ...
        @Override // gatewayprotocol.v1.DiagnosticEventRequestOuterClass.DiagnosticTagOrBuilder
        public int getTagTypeValue(int i6) {
            return this.tagType_.getInt(i6);
        }
    ...
    public interface DiagnosticTagOrBuilder extends MessageLiteOrBuilder {
        ...
        DiagnosticTagType getTagType(int i6);

        int getTagTypeCount();

        List<DiagnosticTagType> getTagTypeList();

        int getTagTypeValue(int i6);
    ...
    public enum DiagnosticTagType implements Internal.EnumLite {
        ...
        DiagnosticTagType(int i6) {
            this.value = i6;
        }

        public static DiagnosticTagType forNumber(int i6) {
            if (i6 != 0) {
                if (i6 != 1) {
                    return null;
                }
        ...
        @Deprecated
        public static DiagnosticTagType valueOf(int i6) {
            return forNumber(i6);
        }
    }
