...
public final class CampaignStateOuterClass {
    ...
    public static final class Campaign extends GeneratedMessageLite<Campaign, Builder> implements CampaignOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Campaign, Builder> implements CampaignOrBuilder {
            public /* synthetic */ Builder(fe.j jVar) {
                this();
            }
            ...
            public Builder setDataVersion(int i6) {
                copyOnWrite();
                ((Campaign) this.instance).setDataVersion(i6);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setDataVersion(int i6) {
            this.dataVersion_ = i6;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            Parser parser;
            fe.j jVar = null;
            switch (fe.j.f5249a[methodToInvoke.ordinal()]) {
                case 1:
                    return new Campaign();
                case 2:
    ...
    public static final class CampaignState extends GeneratedMessageLite<CampaignState, Builder> implements CampaignStateOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<CampaignState, Builder> implements CampaignStateOrBuilder {
            ...
            public Campaign getLoadedCampaigns(int i6) {
                return ((CampaignState) this.instance).getLoadedCampaigns(i6);
            }
            ...
            @Override // gatewayprotocol.v1.CampaignStateOuterClass.CampaignStateOrBuilder
            public Campaign getShownCampaigns(int i6) {
                return ((CampaignState) this.instance).getShownCampaigns(i6);
            }
            ...
            public Builder removeLoadedCampaigns(int i6) {
                copyOnWrite();
                ((CampaignState) this.instance).removeLoadedCampaigns(i6);
                return this;
            }

            public Builder removeShownCampaigns(int i6) {
                copyOnWrite();
                ((CampaignState) this.instance).removeShownCampaigns(i6);
                return this;
            }

            public Builder setLoadedCampaigns(int i6, Campaign campaign) {
                copyOnWrite();
                ((CampaignState) this.instance).setLoadedCampaigns(i6, campaign);
                return this;
            }

            public Builder setShownCampaigns(int i6, Campaign campaign) {
                copyOnWrite();
                ((CampaignState) this.instance).setShownCampaigns(i6, campaign);
                return this;
            }
            ...
            public Builder addLoadedCampaigns(int i6, Campaign campaign) {
                copyOnWrite();
                ((CampaignState) this.instance).addLoadedCampaigns(i6, campaign);
                return this;
            }

            public Builder addShownCampaigns(int i6, Campaign campaign) {
                copyOnWrite();
                ((CampaignState) this.instance).addShownCampaigns(i6, campaign);
                return this;
            }

            public Builder setLoadedCampaigns(int i6, Campaign.Builder builder) {
                copyOnWrite();
                ((CampaignState) this.instance).setLoadedCampaigns(i6, builder.build());
                return this;
            }

            public Builder setShownCampaigns(int i6, Campaign.Builder builder) {
                copyOnWrite();
                ((CampaignState) this.instance).setShownCampaigns(i6, builder.build());
                return this;
            }
            ...
            public Builder addLoadedCampaigns(int i6, Campaign.Builder builder) {
                copyOnWrite();
                ((CampaignState) this.instance).addLoadedCampaigns(i6, builder.build());
                return this;
            }

            public Builder addShownCampaigns(int i6, Campaign.Builder builder) {
                copyOnWrite();
                ((CampaignState) this.instance).addShownCampaigns(i6, builder.build());
                return this;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setLoadedCampaigns(int i6, Campaign campaign) {
            campaign.getClass();
            ensureLoadedCampaignsIsMutable();
            this.loadedCampaigns_.set(i6, campaign);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setShownCampaigns(int i6, Campaign campaign) {
            campaign.getClass();
            ensureShownCampaignsIsMutable();
            this.shownCampaigns_.set(i6, campaign);
        }
        ...
        @Override // gatewayprotocol.v1.CampaignStateOuterClass.CampaignStateOrBuilder
        public Campaign getLoadedCampaigns(int i6) {
            return this.loadedCampaigns_.get(i6);
        }
        ...
        public CampaignOrBuilder getLoadedCampaignsOrBuilder(int i6) {
            return this.loadedCampaigns_.get(i6);
        }
        ...
        @Override // gatewayprotocol.v1.CampaignStateOuterClass.CampaignStateOrBuilder
        public Campaign getShownCampaigns(int i6) {
            return this.shownCampaigns_.get(i6);
        }
        ...
        public CampaignOrBuilder getShownCampaignsOrBuilder(int i6) {
            return this.shownCampaigns_.get(i6);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addLoadedCampaigns(int i6, Campaign campaign) {
            campaign.getClass();
            ensureLoadedCampaignsIsMutable();
            this.loadedCampaigns_.add(i6, campaign);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addShownCampaigns(int i6, Campaign campaign) {
            campaign.getClass();
            ensureShownCampaignsIsMutable();
            this.shownCampaigns_.add(i6, campaign);
        }
    ...
    public interface CampaignStateOrBuilder extends MessageLiteOrBuilder {
        Campaign getLoadedCampaigns(int i6);

        int getLoadedCampaignsCount();

        List<Campaign> getLoadedCampaignsList();

        Campaign getShownCampaigns(int i6);
