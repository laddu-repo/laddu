...
public final class HeaderBiddingTokenOuterClass {
    ...
    public static final class HeaderBiddingToken extends GeneratedMessageLite<HeaderBiddingToken, Builder> implements HeaderBiddingTokenOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<HeaderBiddingToken, Builder> implements HeaderBiddingTokenOrBuilder {
            public /* synthetic */ Builder(fe.r rVar) {
                this();
            }
            ...
            public Builder setAdFormatValue(int i6) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setAdFormatValue(i6);
                return this;
            }
            ...
            public Builder setTokenNumber(int i6) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setTokenNumber(i6);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setTokenNumber(int i6) {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            Parser parser;
            fe.r rVar = null;
            switch (fe.r.f5260a[methodToInvoke.ordinal()]) {
                case 1:
                    return new HeaderBiddingToken();
                case 2:
                    return new Builder(rVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0017\u0000\u0001\u0001\u0017\u0017\u0001\u0000\u0000\u0001\n\u0002\u0004\u0003\n\u0004ဉ\u0000\u0005ဉ\u0001\u0006ဉ\u0002\u0007ဉ\u0003\bဉ\u0004\tဉ\u0005\nဉ\u0006\u000bည\u0007\fဇ\b\rဉ\t\u000eဉ\n\u000fဌ\u000b\u0010ဉ\f\u0011ဉ\r\u0012ဇ\u000e\u00132\u0014ဉ\u000f\u0015Ȉ\u0016ဉ\u0010\u0017ለ\u0011", new Object[]{"bitField0_", "tokenId_", "tokenNumber_", "sessionToken_", "clientInfo_", "timestamps_", "sessionCounters_", "staticDeviceInfo_", "dynamicDeviceInfo_", "pii_", "campaignState_", "tcf_", "scarSignalsCollected_", "limitedSessionToken_", "initializationData_", "adFormat_", "testData_", "tokenCounters_", "offerwallEnabled_", "extras_", d0.f5576a, "mediationInfo_", "placementId_", "bannerSize_", "mediationAdUnitId_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        public AdRequestOuterClass.BannerSize getBannerSize() {
            ...
            if (bannerSize == null) {
                return AdRequestOuterClass.BannerSize.getDefaultInstance();
            }
            return bannerSize;
        }
    ...
    public static final class TokenCounters extends GeneratedMessageLite<TokenCounters, Builder> implements TokenCountersOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<TokenCounters, Builder> implements TokenCountersOrBuilder {
            ...
            public Builder setSeq(int i6) {
                copyOnWrite();
                ((TokenCounters) this.instance).setSeq(i6);
                return this;
            }

            public Builder setStarts(int i6) {
                copyOnWrite();
                ((TokenCounters) this.instance).setStarts(i6);
                return this;
            }

            public Builder setWins(int i6) {
                copyOnWrite();
                ((TokenCounters) this.instance).setWins(i6);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setStarts(int i6) {
            this.starts_ = i6;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setWins(int i6) {
            this.wins_ = i6;
        }
