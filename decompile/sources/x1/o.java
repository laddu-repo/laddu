...
public abstract class o {
    ...
    public static final byte[] f14146a = {0, 0, 0, 1};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final float[] f14147b = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final Object f14148c = new Object();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static int[] f14149d = new int[10];
    ...
    public static boolean c(byte[] bArr, int i, t1.o oVar) {
        int i10;
        if (Objects.equals(oVar.f12061n, "video/avc")) {
            byte b9 = bArr[4];
            if (((b9 & 96) >> 5) == 0 && ((i10 = b9 & 31) == 1 || i10 == 9 || i10 == 14)) {
                return false;
            }
        } else if (Objects.equals(oVar.f12061n, "video/hevc")) {
            b8.d dVarE = e(new u3.f(bArr, 4, i + 4));
            int i11 = dVarE.f1575a;
            if (i11 == 35) {
                return false;
            }
            if (i11 <= 14 && i11 % 2 == 0 && dVarE.f1577c == oVar.E - 1) {
                return false;
            }
        }
        return true;
    ...
    public static int d(t1.o oVar) {
        if (Objects.equals(oVar.f12061n, "video/avc")) {
            return 1;
        }
        return (Objects.equals(oVar.f12061n, "video/hevc") || f0.c(oVar.f12058k, "video/hevc") != null) ? 2 : 0;
    }

    public static b8.d e(u3.f fVar) {
        fVar.s();
        return new b8.d(fVar.i(6), fVar.i(6), fVar.i(3) - 1);
    }
    ...
    */
    public static x1.h f(u3.f r19, boolean r20, int r21, x1.h r22) {
        /*
            r0 = r19
            r1 = r21
            r2 = r22
        ...
        L7b:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: x1.o.f(u3.f, boolean, int, x1.h):x1.h");
    }

    public static ab.c g(byte[] bArr, int i, int i10) {
        byte b9;
        int i11 = i + 2;
        do {
            i10--;
        ...
        u3.f fVar = new u3.f(bArr, i11, i10 + 1);
        while (fVar.d(16)) {
            int i12 = fVar.i(8);
            int i13 = 0;
            while (i12 == 255) {
            ...
            if (i14 == 176) {
                ...
                for (int i18 = 0; i18 <= iM3; i18++) {
                    ...
                    fVar.i(i19 == 0 ? Math.max(0, iM - 30) : Math.max(0, (i19 + iM) - 31));
                    if (zH) {
                        int i20 = fVar.i(6);
                        if (i20 == 63) {
                            return null;
                        }
                        fVar.i(i20 == 0 ? Math.max(0, iM2 - 30) : Math.max(0, (i20 + iM2) - 31));
                    }
                    if (fVar.h()) {
                        fVar.t(10);
                    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static x1.k h(byte[] r32, int r33, int r34, sb.p r35) {
        /*
            Method dump skipped, instruction units count: 1003
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: x1.o.h(byte[], int, int, sb.p):x1.k");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static sb.p i(byte[] r38, int r39, int r40) {
        /*
            Method dump skipped, instruction units count: 2084
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: x1.o.i(byte[], int, int):sb.p");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static x1.n j(byte[] r30, int r31, int r32) {
        /*
            Method dump skipped, instruction units count: 634
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: x1.o.j(byte[], int, int):x1.n");
    }

    public static void k(u3.f fVar) {
        int iM = fVar.m() + 1;
        fVar.t(8);
        for (int i = 0; i < iM; i++) {
            fVar.m();
        ...
        synchronized (f14148c) {
            ...
            while (i11 < i) {
                ...
                if (i11 < i) {
                    int[] iArr = f14149d;
                    if (iArr.length <= i12) {
                        f14149d = Arrays.copyOf(iArr, iArr.length * 2);
                    }
                    f14149d[i12] = i11;
                    i11 += 3;
                    i12++;
