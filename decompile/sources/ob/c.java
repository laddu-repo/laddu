...
public final class c {
    ...
    public static final String[] f10101c = {"*", "FCM", "GCM", ""};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final SharedPreferences f10102a;
    ...
    */
    public c(fa.g r4) {
        /*
            ...
            r3.<init>()
            r4.a()
            android.content.Context r0 = r4.f5336a
            ...
            r4.a()
            fa.j r0 = r4.f5338c
            java.lang.String r1 = r0.f5353e
            if (r1 == 0) goto L1b
            goto L48
        L1b:
            r4.a()
            java.lang.String r1 = r0.f5350b
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ob.c.<init>(fa.g):void");
    }

    public final String a() {
        String string;
        synchronized (this.f10102a) {
            string = this.f10102a.getString("|S|id", null);
        }
        return string;
    }
    ...
    public final String b() {
        ...
        synchronized (this.f10102a) {
            ...
            String string = this.f10102a.getString("|S||P|", null);
            if (string == null) {
                return null;
            }
            try {
