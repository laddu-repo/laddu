...
public final class g {
    ...
    public static final boolean f8034l = Log.isLoggable("ExifInterface", 3);

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final int[] f8035m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final int[] f8036n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final byte[] f8037o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final byte[] f8038p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static final byte[] f8039q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final byte[] f8040r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final byte[] f8041s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final byte[] f8042t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public static final byte[] f8043u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public static final byte[] f8044v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public static final byte[] f8045w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public static final byte[] f8046x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final byte[] f8047y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public static final byte[] f8048z;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final FileDescriptor f8049a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final AssetManager.AssetInputStream f8050b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public int f8051c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final HashMap[] f8052d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final HashSet f8053e;
    public ByteOrder f;
    ...
    static {
        ...
        f8035m = new int[]{8, 8, 8};
        f8036n = new int[]{8};
        f8037o = new byte[]{-1, -40, -1};
        f8038p = new byte[]{102, 116, 121, 112};
        f8039q = new byte[]{109, 105, 102, 49};
        f8040r = new byte[]{104, 101, 105, 99};
        f8041s = new byte[]{79, 76, 89, 77, 80, 0};
        f8042t = new byte[]{79, 76, 89, 77, 80, 85, 83, 0, 73, 73};
        f8043u = new byte[]{-119, 80, 78, 71, 13, 10, 26, 10};
        f8044v = new byte[]{101, 88, 73, 102};
        f8045w = new byte[]{73, 72, 68, 82};
        f8046x = new byte[]{73, 69, 78, 68};
        f8047y = new byte[]{82, 73, 70, 70};
        f8048z = new byte[]{87, 69, 66, 80};
        ...
        while (true) {
            ...
            if (i >= dVarArr6.length) {
                HashMap map = K;
                d[] dVarArr7 = G;
                map.put(Integer.valueOf(dVarArr7[0].f8028a), 5);
                map.put(Integer.valueOf(dVarArr7[1].f8028a), 1);
                map.put(Integer.valueOf(dVarArr7[2].f8028a), 2);
                map.put(Integer.valueOf(dVarArr7[3].f8028a), 3);
                map.put(Integer.valueOf(dVarArr7[4].f8028a), 7);
                map.put(Integer.valueOf(dVarArr7[5].f8028a), 8);
                Pattern.compile(".*[1-9].*");
            ...
            for (d dVar : dVarArr6[i]) {
                H[i].put(Integer.valueOf(dVar.f8028a), dVar);
                I[i].put(dVar.f8029b, dVar);
            }
            i++;
        }
    }
    ...
    */
    public g(java.io.InputStream r10) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: l1.g.<init>(java.io.InputStream):void");
    }
    ...
    public final String b(String str) {
        ...
        if (cVarC != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                e eVar = eVarArr[0];
                Integer numValueOf = Integer.valueOf((int) (eVar.f8032a / eVar.f8033b));
                e eVar2 = eVarArr[1];
                Integer numValueOf2 = Integer.valueOf((int) (eVar2.f8032a / eVar2.f8033b));
                e eVar3 = eVarArr[2];
                return String.format("%02d:%02d:%02d", numValueOf, numValueOf2, Integer.valueOf((int) (eVar3.f8032a / eVar3.f8033b)));
            }
            try {
    ...
    public final c c(String str) {
        ...
        for (int i = 0; i < F.length; i++) {
            c cVar = (c) this.f8052d[i].get(str);
            if (cVar != null) {
                return cVar;
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void e(l1.b r23, int r24, int r25) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 540
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: l1.g.e(l1.b, int, int):void");
    }
    ...
    */
    public final int f(java.io.BufferedInputStream r18) throws java.lang.Throwable {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: l1.g.f(java.io.BufferedInputStream):int");
    }
    ...
    public final void h(b bVar) throws IOException {
        ...
        bVar.f8021w = ByteOrder.BIG_ENDIAN;
        byte[] bArr = f8043u;
        bVar.a(bArr.length);
        ...
        while (true) {
            try {
                ...
                int i10 = length + 8;
                if (i10 == 16 && !Arrays.equals(bArr2, f8045w)) {
                    throw new IOException("Encountered invalid PNG file--IHDR chunk should appearas the first chunk");
                }
                if (Arrays.equals(bArr2, f8046x)) {
                    return;
                }
                if (Arrays.equals(bArr2, f8044v)) {
                    byte[] bArr3 = new byte[i];
                    if (bVar.read(bArr3) != i) {
                        throw new IOException("Failed to read given length for given PNG chunk type: " + t1.b(bArr2));
                    }
    ...
    public final void i(b bVar) throws IOException {
        ...
        bVar.a(i - bVar.f8022x);
        bVar.read(bArr4);
        e(new b(bArr4), i, 5);
        bVar.a(i11 - bVar.f8022x);
        bVar.f8021w = ByteOrder.BIG_ENDIAN;
        ...
        for (int i13 = 0; i13 < i12; i13++) {
            ...
            if (unsignedShort == E.f8028a) {
                short s3 = bVar.readShort();
                short s10 = bVar.readShort();
                c cVarC = c.c(s3, this.f);
                c cVarC2 = c.c(s10, this.f);
                HashMap[] mapArr = this.f8052d;
                mapArr[0].put("ImageLength", cVarC);
                mapArr[0].put("ImageWidth", cVarC2);
                if (z2) {
                    Log.d("ExifInterface", "Updated to length: " + ((int) s3) + ", width: " + ((int) s10));
                    return;
                }
                return;
            }
    ...
    public final void k(f fVar) throws IOException {
        ...
        if (cVar != null) {
            e(new b(cVar.f8027d), (int) cVar.f8026c, 5);
        }
    ...
    public final void l(b bVar) throws IOException {
        ...
        bVar.f8021w = ByteOrder.LITTLE_ENDIAN;
        bVar.a(f8047y.length);
    ...
    public final void m(b bVar, HashMap map) throws IOException {
        ...
        if (iE > 0 && iE2 > 0 && this.f8050b == null && this.f8049a == null) {
            bVar.skip(iE);
    ...
    public final void o(f fVar) throws IOException {
        ...
        if (i10 < 8) {
            throw new IOException(d0.d.h(i10, "Invalid first Ifd offset: "));
        }
        int i11 = i10 - 8;
        if (i11 > 0) {
            fVar.a(i11);
    ...
    public final void p() {
        ...
        while (true) {
            ...
            StringBuilder sbO = d0.d.o(i, "The size of tag group[", "]: ");
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void s(l1.f r36, int r37) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 951
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: l1.g.s(l1.f, int):void");
    }
    ...
    public final void u(b bVar) throws IOException {
        ...
        if (cVar3 != null) {
            ...
            int[] iArr2 = f8035m;
            if (Arrays.equals(iArr2, iArr) || (this.f8051c == 3 && (cVar = (c) map.get("PhotometricInterpretation")) != null && (((iE = cVar.e(this.f)) == 1 && Arrays.equals(iArr, f8036n)) || (iE == 6 && Arrays.equals(iArr, iArr2))))) {
                c cVar4 = (c) map.get("StripOffsets");
                c cVar5 = (c) map.get("StripByteCounts");
                if (cVar4 == null || cVar5 == null) {
                    return;
                }
                long[] jArrD = t1.d(cVar4.g(this.f));
                long[] jArrD2 = t1.d(cVar5.g(this.f));
                ...
                int i = 0;
                int i10 = 0;
                for (int i11 = 0; i11 < jArrD.length; i11++) {
                    int i12 = (int) jArrD[i11];
                    int i13 = (int) jArrD2[i11];
                    if (i11 < jArrD.length - 1 && i12 + i13 != jArrD[i11 + 1]) {
                        this.f8054g = false;
                    }
                    int i14 = i12 - i;
                    if (i14 < 0) {
