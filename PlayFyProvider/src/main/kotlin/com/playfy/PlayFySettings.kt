...
class PlayFySettings(
    private val plugin: PlayFyPlugin,
    ...
    override fun onCreateView(
        ...
        val layoutId =
            plugin.resources?.getIdentifier("settings", "layout", "com.laddu100")
        return layoutId?.let {
    ...
    private fun getPlaylistRow(playlistName: String): RelativeLayout {
        ...
        val relativeLayout = RelativeLayout(this@PlayFySettings.requireContext()).apply {
        ...
        // Create CheckBox
        val checkBox = CheckBox(this@PlayFySettings.requireContext()).apply {
        ...
        // Create TextView
        val textView = TextView(this@PlayFySettings.requireContext()).apply {
            id = View.generateViewId()
